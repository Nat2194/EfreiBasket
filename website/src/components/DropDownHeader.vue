<template>
	<div class="relative inline-block" @click="toggleMobileMenu">
		<!-- Dropdown toggle button -->
		<button
			class="relative z-10 block p-2 border border-transparent rounded-md text-white menu-icon focus:border-blue-500 focus:ring-opacity-40 focus:ring-blue-400 focus:ring focus:outline-none"
		>
			<svg
		...
		>
			...
			<a
				...
				class="flex items-center p-3 text-sm dropdown-menu capitalize transition-colors duration-300 transform text-gray-300 hover:text-white"
			>
				<img src="../assets/img/icons/register.svg" class="icon" />

				<span class="mx-1">Inscription</span>
			</a>
		</div>
	</div>
</template>
